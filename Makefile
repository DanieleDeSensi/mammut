...
# Cppcheck performed on Linux sources.
	cppcheck --xml --xml-version=2 --enable=warning,performance,information,style $(TEST_FLAGS) --error-exitcode=1  . -imammut/external -itest 2> cppcheck-report.xml || (cat cppcheck-report.xml; exit 2) 
